...
/**
 * RestyleBg — the single, continuous background for the whole FounderSignal video. Field
 * is the base; the violet bloom rides on top and cross-dissolves ONLY at the
 * two real boundaries:
 ...
 * Adapted from Ella RestyleBg with identical math.
 */
