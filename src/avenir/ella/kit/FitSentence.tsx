...
/**
 * FitSentence — the avenir "FitToFrame" effect, re-toned for Ella: the first
 ...
 * the Ella gradient. Forked from Ares FitSentence (aresFill → ellaFill).
 */
    ...
    >
      <div style={{ display: 'flex', alignItems: 'baseline', whiteSpace: 'nowrap', fontFamily: FONT_FAMILY, fontWeight: weight, fontSize, letterSpacing: '-0.02em', gap: `${gapPx}px` }}>
        {prog.map((d, i) => {
          ...
          const em: React.CSSProperties = isEm ? { ...ellaFill(frame, onBloom), fontStyle: 'italic' } : { color };
          return (
